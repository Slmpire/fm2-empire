...
// Uses @supabase/ssr createBrowserClient so session cookies
// are set correctly for the middleware to read on every
...
export default function AdminLoginPage() {
  ...
  // Use createBrowserClient so cookies are set correctly
